...
class WithdrawMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        send_transaction_email(self.request.user,amount,"Withdrawal Message",
...
class LoanRequestView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        send_transaction_email(self.request.user,amount,"Loan Request Message",
...
class TransferAmountView(TransactionCreateMixin):
